...
$stmt = $conn->prepare("INSERT INTO weekly_reports (user_id, week_start, week_end, title, description) VALUES (?, ?, ?, ?, ?)");
$stmt->bind_param("issss", $user_id, $week_start, $week_end, $title, $description);
